const TagIcon = ({ isActive, className = "" }) => {
  return (
    ...
    // </svg>
    <svg className={`${className} text-red-500 h-[24px] w-[24px]`} viewBox="0 0 24 24" fill="none" stroke={isActive ? "#ffffff" : "#8A8A8F"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
