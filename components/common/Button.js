const Button = ({ label, onClick, className = "", isUppercase = true, isDisabled = false }) => {
  ...
  const baseClass = "xs:w-full inline-block h-[40px] w-[335px] text-black cursor-pointer text-center leading-none px-[12px] py-[13px] rounded-[4px] bg-white text-[14px] font-bold duration-300";
